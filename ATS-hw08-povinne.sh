...
echo "\n\033[0;31m!!!! Warning! in hw08 their generator creates solution for optional part, so there maybe errors even if your mandatory solution is correct!\n In mandatory solution look only at public examples!\033[0m \n"
